...
const Home = () => {
    ...
    useEffect(() => {
        fetchData('http://15.237.160.124:4000/api/age-distribution', 'en France'); // Charger les données de toute la France au montage
    ...
    const handleRegionClick = (region) => {
        ...
        fetchData(`http://15.237.160.124:4000/api/age-distribution/${region}`, `en ${region}`);
